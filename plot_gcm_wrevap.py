    ...
    try:
        ...
        for res_name in res_name_list:
            ...
            if res_list and res_name not in res_list:
                continue
            logging.info('{0}'.format(res_name))
            ...
            for csv_i, (csv_name, csv_path) in enumerate(csv_list):
                logging.info('  {0}'.format(csv_name))
            ...
            if not os.path.isfile(plot_path):
                ...
                plt.title('{0}'.format(res_name.replace('_', ' ')))
                plt.xlabel('Year')
                if plot_si_units: plt.ylabel('Mean Annual Temperature [C]')
                else: plt.ylabel('Mean Annual Temperature [F]')
            ...
            if not os.path.isfile(plot_path):
                ...
                plt.title('{0}'.format(res_name.replace('_', ' ')))
                plt.xlabel('Year')
                if plot_si_units: plt.ylabel('Mean Annual Dewpoint [C]')
                else: plt.ylabel('Mean Annual Dewpoint [F]')
                plt.xlim([year_index[0], year_index[-1]])
                plt.savefig(plot_path, bbox_inches='tight')
                plt.close()
            ...
            if not os.path.isfile(plot_path):
                ...
                plt.title('{0}'.format(res_name.replace('_', ' ')))
                plt.xlabel('Year')
                if plot_si_units: plt.ylabel('Mean Annual Thornton-Running Solar [W/m^2]')
                else: plt.ylabel('Mean Annual Thornton-Running Solar [W/m^2]')
                plt.xlim([year_index[0], year_index[-1]])
                plt.savefig(plot_path, bbox_inches='tight')
                plt.close()
            ...
            if not os.path.isfile(plot_path):
                ...
                plt.title('{0}'.format(res_name.replace('_', ' ')))
                plt.xlabel('Year')
                if plot_si_units: plt.ylabel('Total Annual Lake ET [mm]')
                else: plt.ylabel('Total Annual Lake ET [in]')
                plt.xlim([year_index[0], year_index[-1]])
                plt.savefig(plot_path, bbox_inches='tight')
                plt.close()
            ...
            if not os.path.isfile(plot_path):
                ...
                plt.title('{0}'.format(res_name.replace('_', ' ')))
                plt.xlabel('Year')
                if plot_si_units: plt.ylabel('Total Annual Potential ET [mm]')
                else: plt.ylabel('Total Annual Potential ET [in]')
                plt.xlim([year_index[0], year_index[-1]])
                plt.savefig(plot_path, bbox_inches='tight')
                plt.close()
            ...
            if not os.path.isfile(plot_path):
                ...
                plt.title('{0}'.format(res_name.replace('_', ' ')))
                plt.xlabel('Year')
                if plot_si_units: plt.ylabel('Total Annual Precipitation [mm]')
                else: plt.ylabel('Total Annual Precipitation [in]')
                plt.xlim([year_index[0], year_index[-1]])
                plt.savefig(plot_path, bbox_inches='tight')
                plt.close()
            ...
            if not os.path.isfile(plot_path):
                ...
                plt.title('{0}'.format(res_name.replace('_', ' ')))
                plt.xlabel('Year')
                if plot_si_units: plt.ylabel('Total Annual Net ET (ET - PPT) [mm]')
                else: plt.ylabel('Total Annual Net ET (ET - PPT) [in]')
                plt.xlim([year_index[0], year_index[-1]])
                plt.savefig(plot_path, bbox_inches='tight')
                plt.close()
